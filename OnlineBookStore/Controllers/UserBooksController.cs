...
namespace OnlineBookStore.Controllers
{
    public class UserBooksController : Controller
    {
        ...
        public UserBooksController(OnlineBookStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineBookStoreContext = _context.UserBooks.Include(u => u.Book);
        ...
        public async Task<IActionResult> Create([Bind("Id,AppUser,BookId")] UserBooks userBooks)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Book, "Id", "Description", userBooks.BookId);
            return View(userBooks);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OnlineBookStoreContext.UserBooks'  is null.");
            }
            var userBooks = await _context.UserBooks.FindAsync(id);
            if (userBooks != null)
            {
